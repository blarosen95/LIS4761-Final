...
Analysis #1:
```{r}
smoker <- read_csv("data/SmokeBan.csv")
...
GGeighties <- ggplot(data = df_eighties, aes(x = smoker, y = age, color = smoker))+
  geom_bar(stat='identity')+
  labs(title = "80's smokers")

#using grid arrange so you can compate all plots side by side
grid.arrange(GGteens, GGtwenties, GGthirtes, GGfourties, GGfities, GGsixties, GGseventies, GGeighties, ncol = 3)
